...
export default function ApplicationsScreen({ navigation }) {
  ...
  // All application services in a single grid
  const menuItems = [
    {
      id: 1,
    ...
    },
    {
      ...
      color: '#5856D6',
      backgroundColor: '#F5F5F7',
      onPress: () => navigation?.navigate('PLNInfo'), // Can be expanded for other document applications
    },
    {
      id: 5,
      title: 'My Reports',
    ...
    <View style={styles.container}>
      ...
      >
        <SafeAreaView edges={['top']}>
          <View style={styles.headerContent}>
            <View style={styles.brandContainer}>
              ...
              <View style={styles.brandTextContainer}>
                ...
                <Text style={styles.subtitleText}>Services & Forms</Text>
              </View>
            </View>
          </View>
          ...
          {/* Search Bar */}
          <SearchInput
            placeholder="Search application services..."
            onSearch={setSearchQuery}
            onClear={() => setSearchQuery('')}
            accessibilityLabel="Search application services"
            accessibilityHint="Type to filter available application options"
          />
        </SafeAreaView>
      </LinearGradient>
