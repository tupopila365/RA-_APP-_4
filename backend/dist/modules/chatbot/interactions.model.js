...
const chatbotInteractionSchema = new mongoose_1.Schema({
    question: {
        type: String,
...
exports.ChatbotInteractionModel = mongoose_1.default.model('ChatbotInteraction', chatbotInteractionSchema);
