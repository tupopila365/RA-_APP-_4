...
class ChatbotService {
    ...
    async processQuery(queryRequest) {
        ...
        const cachedResponse = await cache_1.cacheService.get('chatbot', cacheKey);
        if (cachedResponse) {
            logger_1.logger.info('Returning cached chatbot response', { question: question.substring(0, 50) });
            return {
                ...cachedResponse,
        ...
        try {
            ...
            await cache_1.cacheService.set('chatbot', cacheKey, formattedResponse, 3600);
