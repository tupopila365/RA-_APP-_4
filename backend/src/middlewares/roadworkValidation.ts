...
export const validateRoadworkCreate = (req: Request, res: Response, next: NextFunction): void => {
...
export const validateRoadworkUpdate = (req: Request, res: Response, next: NextFunction): void => {
  const { title, road, section, region, status, coordinates, priority } = req.body;
  const errors: string[] = [];
